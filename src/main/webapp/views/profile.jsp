            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-4 h-100">
                    <div class="position-relative d-inline-block mx-auto mb-3">
                        <c:choose>
                            <c:when test="${not empty currentUser.images and currentUser.images != 'default-avatar.png'}">
                                <img id="avatarPreview" src="${pageContext.request.contextPath}/uploads/users/${currentUser.images}" alt="Avatar" class="rounded-circle border border-4 border-primary-subtle shadow-sm object-fit-cover" style="width: 140px; height: 140px;">
                            </c:when>
                            <c:otherwise>
                    ...
                    <h4 class="fw-bold mb-1">${currentUser.fullName != null ? currentUser.fullName : currentUser.username}</h4>
                    ...
                    <ul class="list-group list-group-flush text-start small border-top pt-3">
                        <li class="list-group-item d-flex justify-content-between px-0 py-2 border-0">
                            ...
                            <span class="fw-semibold text-truncate ms-2" style="max-width: 180px;">${currentUser.email}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between px-0 py-2 border-0">
                            <span class="text-muted"><i class="bi bi-telephone me-2 text-primary"></i>Điện thoại:</span>
                            <span class="fw-semibold">${not empty currentUser.phone ? currentUser.phone : 'Chưa cập nhật'}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between px-0 py-2 border-0">
                            <span class="text-muted"><i class="bi bi-key me-2 text-primary"></i>Mã User ID:</span>
                            <span class="fw-semibold font-monospace text-truncate ms-2" style="max-width: 150px;">${currentUser.id}</span>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light" value="${currentUser.username}" disabled readonly>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control bg-light" value="${currentUser.email}" disabled readonly>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control" id="fullName" name="fullName" value="${currentUser.fullName}" required minlength="2" maxlength="100" placeholder="Nguyễn Văn A">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" value="${currentUser.phone}" pattern="^(0|\+84)(3|5|7|8|9)[0-9]{8}$" placeholder="0912345678">
